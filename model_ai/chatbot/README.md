...
- **Ví dụ Curl:**
  ```bash
  curl -X GET "http://localhost:8000/chat/4ed2b013-a771-42e6-9b49-5b66a1aa93d7/history"
  ```
- **Phản hồi:** 
  ```json
  {
...
- **Ví dụ Curl:**
  ```bash
  curl -X DELETE "http://localhost:8000/chat/4ed2b013-a771-42e6-9b49-5b66a1aa93d7"
  ```
- **Phản hồi:** 
  ```json
  {
...
- **400 Bad Request:** Tin nhắn rỗng.
- **404 Not Found:** `session_id` không tồn tại.
>>>>>>> main:model_ai/chatbot/README.md
