                ...
                <div className="bg-white/10 dark:bg-black/20 backdrop-blur-xl border border-white/20 dark:border-white/10 shadow-2xl rounded-xl p-8 md:p-10 flex flex-col items-center">
                    <div className="flex flex-col items-center gap-3 mb-8 text-center">
                        ...
                        <div>
                            ...
                            <p className="text-white/70 text-sm mt-1">Join the adventure today</p>
                        </div>
                    </div>
                    ...
                    <div className="w-full mb-8">
                        <div className="flex border-b border-white/10 gap-8 justify-center">
                            <a className="flex flex-col items-center justify-center border-b-[3px] border-transparent text-white/50 hover:text-white/80 pb-3 transition-all duration-300" href="#" onClick={(e) => { e.preventDefault(); onNavigate('login'); }}>
                                <p className="text-sm font-bold leading-normal tracking-wide">Login</p>
                            </a>
                            <a className="flex flex-col items-center justify-center border-b-[3px] border-primary text-white pb-3 transition-all duration-300" href="#" onClick={(e) => { e.preventDefault(); onNavigate('register'); }}>
                    ...
                    <form className="w-full space-y-4" onSubmit={(e) => e.preventDefault()}>
                        ...
                        <div className="space-y-2">
                            <label className="text-white/90 text-sm font-medium ml-1">Confirm Password</label>
                            <div className="relative">
                                <span className="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-white/40 text-xl">lock</span>
                                <input
                                    className="w-full bg-white/5 border border-white/10 rounded-xl py-3.5 pl-12 pr-4 text-white placeholder:text-white/30 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all"
                        ...
                        <div className="flex items-center mt-2 px-1">
                            <label className="flex items-start gap-2 cursor-pointer group">
                                <input
                                    className="rounded border-white/20 bg-white/5 text-primary focus:ring-primary/50 mt-1"
                                    type="checkbox"
                                />
                                <span className="text-white/60 text-xs group-hover:text-white/80 transition-colors leading-relaxed">
                    ...
                    <div className="w-full flex items-center gap-4 my-8">
                        ...
                        <span className="text-white/40 text-[10px] font-bold tracking-[0.2em] uppercase">Or Register With</span>
                        <div className="h-[1px] flex-1 bg-white/10"></div>
                    </div>
                    ...
                    <p className="mt-8 text-white/50 text-sm">
                        ...
                        <a className="text-primary font-bold hover:underline underline-offset-4 ml-1" href="#" onClick={(e) => { e.preventDefault(); onNavigate('login'); }}>Sign In</a>
                    </p>
                </div>
            </main>
        </div>
